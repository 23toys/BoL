...
function MysticShot()
        if IsSACReborn and QAble and AutoCarry.PluginMenu.useQ then ProdictQ:GetPredictionCallBack(Target, CastQ)
...
function EssenceFluxReset()
        if WAble and AutoCarry.Orbwalker:IsAfterAttack() and AutoCarry.PluginMenu.useW and AutoCarry.PluginMenu.resetW then ProdictW:GetPredictionCallBack(Target, CastW) end
end

function MysticShot2()
        if IsSACReborn and QAble and AutoCarry.PluginMenu.useQ2 then ProdictQ:GetPredictionCallBack(Target, CastQ)
